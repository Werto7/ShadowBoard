...
'Part1'						=>	'Part 1 — Data folder setup',
'Part1 intro'				=>	'Please enter the requested information in order to setup your data folder for PunBB.',
'Data folder name'				=>	'Data folder name',
'Data folder name info'		=>	'Enter the name of the data folder that PunBB will be installed into. The data folder must exist. This is the relative path to the data folder.',
'Data folder name help'		=>	'Relative path of existing data folder PunBB will be installed to.',
